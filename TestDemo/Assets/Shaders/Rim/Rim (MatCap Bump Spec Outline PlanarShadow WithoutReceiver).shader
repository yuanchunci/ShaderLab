Shader "kokichi/Mobile/Rim/MatCap/Bump Spec Outline PlanarShadow(WithoutReceiver)
"
{
	Properties
	{
		...
		_SpecMap ("Specular Mask", 2D) = "white" {}
		...
		_Shininess ("Shininess", Range(0,1)) = 128
      	_Shininess ("Shininess", Float) = 128
	...
	Subshader
	{
		...
		Pass
		{
			...
			#include "RimInput2.cginc"
			#include "RimFunc2.cginc"
