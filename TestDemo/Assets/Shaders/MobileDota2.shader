...
//               UNITY_LIGHTMODEL_AMBIENT.rgb * _ambientscale;
            ...
            specularReflection = attenuation * _LightColor0.rgb
                  * _specularcolor.rgb * pow(max(0.0, dot(
                  reflectionVector, 
                  viewDirection)), Mask2.a * _specularexponent);
//            finalColor.rgb = diffuseColor * (diffuseReflection + ambientLighting);
            ...
            fixed3 specular = specularReflection * _specularscale
            	* Mask2.r
            	* lerp(finalColor.rgb + Mask1.b, _specularcolor,  Mask2.b) * NdotL
            	* attenuation;
			finalColor.rgb += specular;
			half3 rimlight = max(Mask2.g, _rimlightblendtofull)
						 * _rimlightscale
						 * _rimlightcolor
			...
			finalColor.rgb += max (Mask1.a, _selfillumblendtofull) * diffuseColor.rgb;
            return finalColor;
         }
		ENDCG
	}
