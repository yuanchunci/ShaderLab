...
SubShader { 
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Transparent" "RenderType"="Transperent" }
  ZWrite Off
...
bkaabaaaaaaaaaaaakaabaaaaaaaaaaadoaaaaab"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="ForwardAdd" "QUEUE"="Transparent" "RenderType"="Transperent" }
  ZWrite Off
  Fog {
   Color (0,0,0,0)
  }
