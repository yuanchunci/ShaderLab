...
public class Sunshine : MonoBehaviour
{
	...
	/// </summary>
	public float ShadowBias { get { return SunLight.shadowBias; } }
	...
	/// The cascade index
	/// </param>
	public float ShadowSlopeBias(int cID) { return SunLight.shadowBias * LightmapTexelPhysicalSize(cID) * 82f * ShadowFilterKernelRadius; }
