...
Shader "Sunshine/Nature/Terrain/Bumped Specular" {
Properties {
...
void vert (inout appdata_full v, out Input o)
{
	...
	v.tangent.w = -1;
	SUNSHINE_INITIALIZE_OUTPUT(Input, o);
...
Dependency "AddPassShader" = "Hidden/Sunshine/Nature/Terrain/Bumped Specular AddPass"
Dependency "BaseMapShader" = "Sunshine/Specular"
