...
Shader "Blackfire Studio/Dota 2/Custom Hero/Custom Hero Advanced Alpha Soft" {
	Properties {
		...
		_cutoff ("Alpha Cutoff", Range(0.0, 0.9)) = 0.0
	...
	SubShader {
		...
		CGPROGRAM
		#pragma target 3.0
		#pragma surface surf CustomHero noambient novertexlights nolightmap nodirlightmap addshadow
		...
		CGPROGRAM
		#pragma target 3.0
		#pragma surface surf CustomHero noambient novertexlights nolightmap nodirlightmap alpha
