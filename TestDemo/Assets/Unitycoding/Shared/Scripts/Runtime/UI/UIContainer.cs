...
namespace Unitycoding{
	public class UIContainer<T> : UIWindow, IDropHandler where T : class{
		[Header("Behaviour")]
		/// <summary>
		...
		/// <summary>
		/// Called when a ItemSlot is double clicked.
		/// </summary>
		...
		/// <summary>
		/// Called when a ItemSlot is clicked.
		/// </summary>
		...
		public virtual bool Add(T item){
			...
			if(dynamicContainer && slotPrefab != null && grid != null){
