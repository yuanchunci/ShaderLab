	...
	public class WelcomeWindow : EditorWindow {
		...
		private void OnGUI(){
			...
			if (Event.current.type == EventType.mouseDown)
			{
				...
				{
					Application.OpenURL("http://zerano-unity3d.com/docs/contact/");
					return;
				}
				...
				{
					Application.OpenURL("http://zerano-unity3d.com/docs/home/icode/examples/");
					return;
				}
				...
				{
					Application.OpenURL("http://zerano-unity3d.com/docs/home/icode/");
					return;
				}
				...
				{
					Application.OpenURL("http://zerano-unity3d.com/Forums/");
					return;
				}
				...
				{
					Application.OpenURL("http://zerano-unity3d.com/docs/home/icode/add-ons/");
					return;
				}
			}
		}
