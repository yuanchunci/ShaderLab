...
//				float LineMask = _Value;
				...
				float4 col = (_Params01.x * tex2D(_BgTex01, PanUV_01)*_Tex01Col) + (_Params01.y * tex2D(_BgTex01, PanUV_02) * _Tex02Col);
				//Multiply the result of the addition with the third channel
				col *= _Params01.z * tex2D(_BgTex01, PanUV_03) * _Tex03Col;
				//Multiply the result with the LineMask and the LineColor
				col += _Params01.w * col * _LineCol * tex2D(_BgTex01, PanUV_02).a * LineMask / (_Params02.y * 20);
